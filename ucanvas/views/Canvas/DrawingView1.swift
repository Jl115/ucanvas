...
//                // Mini-map
//                MiniMapView(
//                    lines: $viewModel.lines,  // Pass lines as binding
//                    shapes: $shapes,  // Pass shapes as binding
//                    offset: $offset,  // Pass offset as binding
//                    currentDragOffset: $currentDragOffset, // Pass currentDragOffset as binding
...
//                    drawingViewModel: $viewModel, // Move this to match the expected order
...
//                        viewModel.lines.append(Line(points: [newPoint], color: selectedColor, lineWidth: selectedLineWidth))
//                    } else {
...
//            .onEnded { _ in
//                if selectedShape == .freeform {
//                    if let last = viewModel.lines.last?.points, last.isEmpty {
